...
//            OrdemDeServico os = new OrdemDeServico("defeitoRelatado", "servico", 250.99, dataNascimento, 12, 51);
//            OrdemDeServico osComPecas = new OrdemDeServico("defeitoRelatado", "servico", 250.99, dataNascimento, 12, 6, 1, 51);
//            new ManipulaBancoOrdemServico().incluir(osComPecas);
            System.out.println(new ManipulaBancoVeiculo().buscar(36));
//            new ManipulaBancoVeiculo().remover(new ManipulaBancoVeiculo().buscar(36));
//            System.out.println(new ManipulaBancoVeiculo().buscar(36));
        } catch (Exception e) {
