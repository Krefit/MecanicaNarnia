...
//  * 0 se for sim, 1 se for não, 2 se for cancelar
    ...
    private void excluirPessoaFisica() {
        try {
            IManipulaBanco<PessoaFisica> mb = new ManipulaBancoPessoaFisica();
            String cpfClienteParaExclusao = String.valueOf(jTableClientes.getValueAt(jTableClientes.getSelectedRow(), 1));
            int idClienteParaExclusao = new ManipulaBancoPessoaFisica().buscar(cpfClienteParaExclusao);
            PessoaFisica pessoaParaRemover = mb.buscar(idClienteParaExclusao);
            mb.remover(pessoaParaRemover);
        } catch (Exception e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(rootPane, e.getMessage());
        }
    ...
    private void adicionarPessoaFisica() {
        try {
            ...
            telefone[1] = tField_telefone.getText();//   * apagando espaços em branco
            telefone[2] = tField_telefone.getText();//   * apagando espaços em branco
