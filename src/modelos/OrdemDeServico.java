...
public class OrdemDeServico {
    ...
    private String dataSaida = null;//só colocar depois de o serviço ser concluido
    ...
    public OrdemDeServico(int id, String defeitoRelatado, ServicosOferecidos servico,
            Funcionario responsavel, float valorServico, String dataEntrada,
    ...
    public OrdemDeServico(int id, String defeitoRelatado, ServicosOferecidos servico,
            Funcionario responsavel, float valorServico, String dataEntrada, SitucaoOrdemServico situacao,
